...
//     public static readonly string[] agents = { "GGBond"};

//     // how many battles we make the two agents fight to determine who's better
//     public int numBattlesToGaugeStrength = 10;
//     GameObject[] stageManagers;
    
//     void Awake() {
//         stageManagers = GameObject.FindGameObjectsWithTag("TrainingArea");

//         for (GameObject sm : stageManagers) {
//             agent1 = Resources.Load<GameObject>(WorldConstants.agent1ID + "/" + WorldConstants.agent1ID);
//             sm.GetComponent<FinalStageManager>().agent1 = 
