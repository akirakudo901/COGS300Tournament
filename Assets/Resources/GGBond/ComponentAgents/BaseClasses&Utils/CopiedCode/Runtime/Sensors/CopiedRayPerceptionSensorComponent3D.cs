...
namespace CopiedCode
{
    ...
    /// </summary>
    [AddComponentMenu("CopiedCode / Copied Ray Perception Sensor 3D", 50)]
    // CHANGED BY AKIRA; ORIGINALLY, [AddComponentMenu("ML Agents/Ray Perception Sensor 3D", (int)MenuGroup.Sensors)]
    // WHERE MenuGroup.Sensors = 50
    public class CopiedRayPerceptionSensorComponent3D : CopiedRayPerceptionSensorComponentBase
    {
