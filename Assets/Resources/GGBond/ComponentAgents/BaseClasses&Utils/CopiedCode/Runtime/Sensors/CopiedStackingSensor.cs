...
namespace CopiedCode
{
    ...
    /// </summary>
    public class CopiedStackingSensor : CopiedISensor, CopiedIBuiltInSensor
    {
        /// <summary>
        /// The wrapped sensor.
        /// </summary>
        CopiedISensor m_WrappedSensor;
        ...
        int m_CurrentIndex;
        CopiedObservationWriter m_LocalWriter = new CopiedObservationWriter();
        ...
        public CopiedStackingSensor(CopiedISensor wrapped, int numStackedObservations)
        {
            ...
            // Set up the cached observation spec for the CopiedStackingSensor
        ...
        /// <inheritdoc/>
        // ORIGINAL! VERSION USING MY COPIED CopiedObservationWriter RIGHT ABOVE!
        ...
        /// </summary>
        internal int[] ConstructStackedCompressedChannelMapping(CopiedISensor wrappedSenesor)
        {
        ...
        {
            CopiedIBuiltInSensor wrappedBuiltInSensor = m_WrappedSensor as CopiedIBuiltInSensor;
