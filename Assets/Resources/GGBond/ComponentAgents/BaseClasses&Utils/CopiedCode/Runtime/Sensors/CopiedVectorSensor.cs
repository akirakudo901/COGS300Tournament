...
namespace CopiedCode
{
    ...
    /// </summary>
    public class CopiedVectorSensor : CopiedISensor, CopiedIBuiltInSensor
    {
        ...
        public CopiedVectorSensor(int observationSize, string name = null, ObservationType observationType = ObservationType.Default)
        {
        ...
        // THIS IS THE NEW CODE USING CopiedObservationWriter TO DO THE EXACT SAME THING
        // AS ABOVE, BECAUSE ITS CONSTRUCTOR WAS INTERNAL.
        ...
        {
            CopiedUtilities.DebugCheckNanAndInfinity(obs, nameof(obs), nameof(AddFloatObs));
        ...
        // ADDED BY AKIRA
        // public static CopiedVectorSensor ConvertVectorSensorToCopied(VectorSensor vs) {
        //     CopiedVectorSensor cvs = new CopiedVectorSensor();
        //     cvs.m_Data = vs.m_Data;
