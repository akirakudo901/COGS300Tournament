...
{
    /// <summary>
    /// Allows sensors to write to both CopiedTensorProxy and float arrays/lists.
    /// </summary>
    public class CopiedObservationWriter
    {
        IList<float> m_Data;
        int m_Offset;

        CopiedTensorProxy m_Proxy;
        int m_Batch;

        TensorShape m_TensorShape;

        public CopiedObservationWriter() { }
        ...
        public void SetTarget(IList<float> data, ObservationSpec observationSpec, int offset)
        {
        ...
        /// <param name="offset">Offset from the start of the float data to write to.</param>
        public void SetTarget(IList<float> data, InplaceArray<int> shape, int offset)
        {
            m_Data = data;
            m_Offset = offset;
            m_Proxy = null;
        ...
        /// <summary>
        /// Set the writer to write to a CopiedCopiedTensorProxy at the given batch and channel offset.
        /// </summary>
        ...
        public void SetTarget(CopiedTensorProxy tensorProxy, int batchIndex, int channelOffset)
        {
            m_Proxy = tensorProxy;
            m_Batch = batchIndex;
    ...
    /// <summary>
    /// Provides extension methods for the CopiedObservationWriter.
    /// </summary>
    public static class CopiedObservationWriterExtension
    {
        /// <summary>
        /// Writes a Texture2D into a CopiedObservationWriter.
        /// </summary>
        ...
        public static int WriteTexture(
            this CopiedObservationWriter obsWriter,
            Texture2D texture,
            bool grayScale)
        {
