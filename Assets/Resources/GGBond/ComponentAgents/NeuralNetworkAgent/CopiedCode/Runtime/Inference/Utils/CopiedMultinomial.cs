...
{
    /// <summary>
    /// CopiedMultinomial - Draws samples from a multinomial distribution given a (potentially unscaled)
    ...
    /// </summary>
    public class CopiedMultinomial
    {
        ...
        /// </param>
        public CopiedMultinomial(int seed)
        {
            m_Random = new System.Random(seed);
        }

        /// <summary>
        /// Samples from the CopiedMultinomial distribution defined by the provided cumulative
        /// mass function.
        /// </summary>
        /// <param name="cmf">
