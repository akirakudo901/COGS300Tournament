...
namespace CopiedCode
{
    ...
    /// </summary>
    [Serializable]
    public class CopiedTensorProxy
    {
    ...
    {
        public static void ResizeTensor(CopiedTensorProxy tensor, int batch, ITensorAllocator allocator)
        {
        ...
        public static CopiedTensorProxy TensorProxyFromBarracuda(Tensor src, string nameOverride = null)
        {
            var shape = TensorShapeFromBarracuda(src.shape);
            return new CopiedTensorProxy
            {
        ...
        /// <summary>
        /// Fill a specific batch of a CopiedTensorProxy with a given value
        /// </summary>
        /// <param name="tensorProxy"></param>
        /// <param name="batch">The batch index to fill.</param>
        /// <param name="fillValue"></param>
        public static void FillTensorBatch(CopiedTensorProxy tensorProxy, int batch, float fillValue)
        {
        ...
        /// <param name="randomNormal">CopiedRandomNormal object used to populate tensor</param>
        ...
        public static void FillTensorWithRandomNormal(
            CopiedTensorProxy tensorProxy, CopiedRandomNormal randomNormal)
        {
