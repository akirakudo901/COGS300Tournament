...
namespace CopiedCode
{
    ...
    /// </summary>
    public abstract class CopiedRayPerceptionSensorComponentBase : CopiedSensorComponent
    {
        ...
        [NonSerialized]
        CopiedRayPerceptionSensor m_RaySensor;

        /// <summary>
        /// Get the CopiedRayPerceptionSensor that was created.
        /// </summary>
        public CopiedRayPerceptionSensor RaySensor
        {
            get => m_RaySensor;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public override CopiedISensor[] CreateSensors()
        {
            var rayPerceptionInput = GetRayPerceptionInput();

            m_RaySensor = new CopiedRayPerceptionSensor(m_SensorName, rayPerceptionInput);

            if (ObservationStacks != 1)
            {
                var stackingSensor = new CopiedStackingSensor(m_RaySensor, ObservationStacks);
                return new CopiedISensor[] { stackingSensor };
            }

            return new CopiedISensor[] { m_RaySensor };
        }
        ...
        void OnDrawGizmosSelected()
        {
            ...
            else
            {
                ...
                {
                    var rayOutput = CopiedRayPerceptionSensor.PerceiveSingleRay(rayInput, rayIndex);
